...
<?if(isset($arResult["DISPLAY_PROPERTIES"]["DOCUMENTS"]["FILE_VALUE"]["SRC"])):?>
	...
	<div  class="exam-review-item-doc"><img class="rew-doc-ico" src="<?=SITE_TEMPLATE_PATH . '/img/icons/pdf_ico_40.png'?>"><a href="<?echo $file["SRC"]?>" download><?=$file["FILE_NAME"]?></a></div>
<?else:?>
